...
namespace knights {
    ...
    class RobotController {
        ...
        public:
             ...
             */
            void follow_route_pursuit(const knights::Route &route, float lookahead_distance = 15.0, const float max_speed = 127.0, bool forwards = true, float end_tolerance = 4.0, float timeout = 5000);
