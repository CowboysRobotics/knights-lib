...
void safer_skills(knights::RobotChassis *chassis) {
	...
	robotControl.lateral_to_position(kPos(-4, -43, rad(270)), false, 3.0, 1000);
	...
	// lady_brown_load1(); pros::delay(500); 
	...
	// robotControl.follow_route_pursuit(
	// 	second_mogo_route, 18.0, 100, false, 4.0, 1500
	// );

	robotControl.turn_to_angle(270, 0, 2.0, 750); robotControl.lateral_move(-60, 8.0, 1500);
	...
	robotControl.lateral_move(20, 2.0, 750); w; 
	robotControl.turn_to_angle(80, 0.0, 3.0, 1000); w;

	robotControl.follow_route_pursuit(
		third_route, 15.0, 80
	); w;

	robotControl.lateral_move(12, 2.0, 650);

	pros::delay(400);

	// robotControl.turn_to_point(kPos(-52, 60, 0));

	robotControl.turn_to_angle(45, 0, 2.0, 750);

	robotControl.lateral_move(14, 4.0, 500);

	robotControl.turn_to_angle(315, 0.0, 2.0, 750); clamp_toggle();

	robotControl.lateral_move(-16, 2.0, 750); 
	...
	robotControl.follow_route_pursuit(
		fourth_route, 18.0, 90
	);

	robotControl.lateral_to_position(kPos(-7, 40, rad(90)), false, 4.0, 2000);
	...
	intake_in(); lady_brown_score(); pros::delay(700); 
	robotControl.lateral_move(-8, 2.0, 750, false); lady_brown_load1(); 
	pros::delay(300); 
	intake_in(); robotControl.lateral_move(10, 2.0, 750, false); 
	pros::delay(500); lady_brown_score(); pros::delay(700);

	lady_brown_down(); robotControl.lateral_move(-6);

	// end of 2nd side

	robotControl.follow_route_pursuit(
		fifth_route, 13.0, 80, false, 8.0, 2000
	); w;
	robotControl.lateral_move(-6, 3.0, 750); clamp_toggle(); lady_brown_load1();

	// robotControl.turn_to_angle(146, 0, 3.0, 750); w;
	// robotControl.lateral_move(-36, 4.0, 1500); w;
	// robotControl.lateral_move(-22, 4.0, 1500); w;

	robotControl.turn_to_angle(90, 0, 2.0, 750); w; intake_in();
	...
	clamp_toggle(); doinker_toggle();

	robotControl.lateral_move(-12, 3.0, 750); w; intake_in(); 

	robotControl.lateral_move(16); w;

	robotControl.lateral_to_point(kPos(38, 24, 90), true, 3.5, 1000, 500);

	// robotControl.turn_to_angle(90, 0, 2.0, 750); w;
	robotControl.turn_to_point(kPos(40, 0, 0), false, 0, 3.0, 1000);

	robotControl.lateral_move(-16); robotControl.lateral_move(-12); clamp_toggle(); w; 
	
	// ^ grab 3rd mogo

	robotControl.turn_to_angle(0, 0, 2.0, 750); w;
	...
	robotControl.lateral_move(-12, 3.0, 750); lady_brown_down(); intake_in();

	robotControl.turn_to_angle(135, 0, 2.0, 750);
	...
	robotControl.turn_to_angle(315,0, 2.0, 750);

	robotControl.lateral_move(26); robotControl.lateral_move(32, 3.0, 750);

	robotControl.turn_to_angle(0,0, 2.0, 750); robotControl.lateral_move(15);

	robotControl.turn_to_angle(235); doinker_toggle(); robotControl.lateral_move(8, 2.0, 750);

	robotControl.turn_to_angle(135, LEFT, 6.0, 1600); clamp_toggle();

	robotControl.lateral_move(-20, 3.0, 750);

	robotControl.lateral_move(10); robotControl.lateral_move(-10);

	lady_brown_score();

	robotControl.lateral_to_position(kPos(22, -22, rad(315)));
...
void red_rush_right_elim(knights::RobotChassis *chassis) {
	...
	AssetStream mogorush(mogorushred_txt);
	auto mogorush_route = knights::init_route_from_asset(mogorush);

	doinker_toggle();

	robotControl.follow_route_pursuit(
		mogorush_route,
		15.0, 90, true, 8.0, 1250
	);

	// robotControl.lateral_move(8);

	robotControl.lateral_to_point(kPos(-24, -36, 0), false, 3.5);

	doinker_toggle();

	robotControl.turn_to_point(kPos(-24, -24, 0), false);
	...
	robotControl.turn_to_angle(265);
...
void blue_rush_left_wp(knights::RobotChassis *chassis) {
	...
	robotControl.turn_to_angle(76, 0); w;
	...
	robotControl.turn_to_point(kPos(24, -24, 0));
	...
	robotControl.turn_to_point(kPos(24, -48, 0)); w;

	robotControl.lateral_move(32);
...
void red_left_wp(knights::RobotChassis *chassis) {
	...
	robotControl.lateral_move(25, 3.0, 750);
...
void sig_red_winpoint(knights::RobotChassis *chassis){
	...
	robotControl.lateral_to_point(kPos(-46, 24, knights::to_rad(270)), true, 3.0, 750);

	// clamp_toggle(); 

	// robotControl.lateral_to_point(kPos(-46,3,knights::to_rad(270)), true, 3.0, 750, 750);

	// pros::delay(200);

	// intake_top.move_velocity(0);

	// robotControl.lateral_to_point(kPos(-46,-18,knights::to_rad(270)), true, 3.0, 750, 200);
	...
	// robotControl.turn_to_point(kPos(-12, 0,0), true, 0, 2.0, 750); lady_brown_score();
...
void sig_blue_winpoint(knights::RobotChassis *chassis){
	...
	robotControl.turn_to_angle(180-42, 0, 2.0, 750); w;
	...
	robotControl.turn_to_angle(180-85, 0, 2.0, 500); w;
	...
	// robotControl.lateral_to_point(kPos(46,3,knights::to_rad(270)), true, 3.0, 750);

	// pros::delay(200);

	// intake_top.move_velocity(0);

	// robotControl.lateral_to_point(kPos(46,-18,knights::to_rad(270)), true, 3.0, 750, 100);
