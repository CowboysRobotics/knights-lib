...
void skills(knights::RobotChassis *chassis, bool flip_x, bool flip_y) {
	...
	robotControl.follow_route_pursuit(
		fourth_route, 18.0, 90, true, 15.0, 2400
	); w;

	robotControl.lateral_to_position(kPos(-7, 41, rad(90)), false, 4.0, 2200); // used to be point
	...
	robotControl.lateral_move(28, 2.0, 750); doinker_toggle(); w;

	robotControl.turn_to_angle(225, 0, 2.0, 800); doinker_toggle();
	...
	robotControl.lateral_to_point(kPos(48, 2, 0), true, 3.0, 300, 0, 0); w;
...
void ring_side_red(knights::RobotChassis *chassis, bool flip_x, bool flip_y) {
	...
	robotControl.turn_to_angle((250 - angle_mod) * x_mod, 0, 3.0, 1000); w;
...
void goal_side_red(knights::RobotChassis *chassis, bool flip_x, bool flip_y) {
	...
	robotControl.lateral_move(32, 3.0, 750);
	// robotControl.curve_move(kPos(-58 * x_mod, 10 * y_mod, 0));
