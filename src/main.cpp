...
void initialize() {
	...
	auton_map["None0"] = knights::Auton(&pp_test, knights::Pos(0, 0, knights::to_rad(90)));
	...
	knights::MotionProfile profile = generator.generate(knights::Pos(0, 0, 90_deg), knights::Pos(24, 24, 0), 120, 0, 0);
