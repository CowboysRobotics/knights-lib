...
void initialize() {
	...
	auton_map["Blue4"] = knights::Auton(&goal_side_red, knights::Pos(-54,36,knights::to_rad(180)), false, false);
	auton_map["Red4"] = knights::Auton(&goal_side_blue, knights::Pos(54,36,knights::to_rad(0)), false, true);

	auton_map["Red1"] = knights::Auton(&ring_side_red, knights::Pos(-54,36,knights::to_rad(180)), false, false);
	auton_map["Blue1"] = knights::Auton(&ring_side_blue, knights::Pos(54,36,knights::to_rad(0)), false, true);
	...
	auton_map["None0"] = knights::Auton(&goal_side_red, knights::Pos(-54,36,knights::to_rad(180)), false, false);
