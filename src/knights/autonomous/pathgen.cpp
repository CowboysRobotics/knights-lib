...
std::vector<squiggles::ProfilePoint> knights::generate_motion_profile(knights::Pos start, knights::Pos end, const float DRIVETRAIN_WIDTH, squiggles::Constraints path_constraints) {
  squiggles::SplineGenerator path_generator = squiggles::SplineGenerator(
    path_constraints, 
    std::make_shared<squiggles::TankModel>(DRIVETRAIN_WIDTH, path_constraints));
